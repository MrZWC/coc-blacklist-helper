...
public class LineManagers {
    ...
    public static LineManagerFactory vertical(int colorResId, float height) {
        return new LineManagerFactory() {
            @Override
            public RecyclerView.ItemDecoration create(RecyclerView recyclerView) {
                return new DividerItemDecoration(recyclerView.getContext(), LinearLayoutManager.VERTICAL, colorResId, height);
            }
        };
    }

    public static LineManagerFactory grid(int colorResId, float height) {
        return new LineManagerFactory() {
            @Override
            public RecyclerView.ItemDecoration create(RecyclerView recyclerView) {
                return new DividerGridItemDecoration(recyclerView.getContext(), colorResId, height);
            }
        };
    }
}
