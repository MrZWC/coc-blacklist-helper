...
public class ClipLayout extends FrameLayout {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ClipLayout, defStyleAttr,
                defStyleRes);
        mRoundSize = a.getDimension(R.styleable.ClipLayout_cl_roundSize, mRoundSize);
        mRoundAsCircle = a.getBoolean(R.styleable.ClipLayout_cl_roundAsCircle, mRoundAsCircle);
        mShowBorder = a.getBoolean(R.styleable.ClipLayout_cl_showBorder, mShowBorder);
        mBorderSize = a.getDimension(R.styleable.ClipLayout_cl_borderSize, mBorderSize);
        mBorderColor = a.getColor(R.styleable.ClipLayout_cl_borderColor, mBorderColor);
        a.recycle();
